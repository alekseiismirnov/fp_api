...
gem 'spring', '~> 4.2', groups: %i[development test]

gem 'pry', '~> 0.14.2', groups: %i[development test]
...
gem 'prettyprint', '~> 0.2.0', groups: %i[development test]

gem 'rubocop', '~> 1.63', group: :development

gem 'rubocop-factory_bot', '~> 2.25', group: :development

gem 'rubocop-rails', '~> 2.24', group: :development

gem 'rubocop-rspec', '~> 2.29', group: :development
